...
import ProseWrapper from '@/components/ProseWrapper.vue';
import MaxContainer from '@/components/MaxContainer.vue';
</script>

<template>
  <div class="sm:pt-24">
    <MaxContainer class="flex-col">
      <h1
        className="text-normal mb-24 font-jost text-5xl leading-[4rem] text-gray-700 dark:text-gray-100"
      >
        About me
      </h1>
      <ProseWrapper>
        ...
        <p>
          ...
          design-driven and helped build exciting and challenging new products.
        </p>
        <p>
        ...
        <ul>
          ...
          <li><strong>Back-end:</strong> Django, Celery, AWS</li>
          <li><strong>Other:</strong> Git, GitHub, CI/CD, Jest</li>
        </ul>
        <h3>Misc. stuff</h3>
        <ul>
          <li>
          ...
          <li>
            I'm currenty listening to a lot of Frank Ocean, Godspeed You! Black
            Emperor and Joanna Newsom.
          </li>
          <li>
            My absolute favourite thing to do is spend time with my wife and two
            young boys.
          </li>
        </ul>
      </ProseWrapper>
